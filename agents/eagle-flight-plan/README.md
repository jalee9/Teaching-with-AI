...
<p align="center">
  <img src="assets/eagle-flight-plan-diagram.png" alt="Eagle Flight Plan Process Diagram" width="850">
</p>
...
|------------|--------------|-------------|
| Courses | Estimate Coursework Time | Time Reality Chart |
| Work Schedule | Calculate Available Time | Weekly Time Visualization |
| Sleep |  | Flight Status |
| Responsibilities |  | Eagle Score |
| Study Preferences |  | Weekly Flight Plan |
